...
import { DashboardCustomizeOutlined, AssessmentOutlined, TuneOutlined, Lock } from '@mui/icons-material';
...
const BottomBar = () => {
  ...
  return (
    ...
    >
      ...
      <BottomNavigationAction label="Login" value="/login" icon={<Lock />} showLabel />
